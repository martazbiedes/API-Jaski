...
//  use jakis - create database
//  db - check if it was successfully created

// 2. Create a collection called bounties
db.createCollection('bounties') - 'create collection'
//  show collections - check if it was succeed
